package ca.uwindsor.cs.mkargar.od.metanome;

import ca.uwindsor.cs.mkargar.od.MainClass;
import ca.uwindsor.cs.mkargar.od.metanome.types.DatatypeString;
...
import ca.uwindsor.cs.mkargar.od.metanome.measurements.Statistics;
import ca.uwindsor.cs.mkargar.od.metanome.sorting.partitions.RowIndexedDateValue;
import ca.uwindsor.cs.mkargar.od.metanome.sorting.partitions.RowIndexedDoubleValue;
import ca.uwindsor.cs.mkargar.od.metanome.sorting.partitions.RowIndexedLongValue;
import ca.uwindsor.cs.mkargar.od.metanome.sorting.partitions.RowIndexedStringValue;
import ca.uwindsor.cs.mkargar.od.metanome.sorting.partitions.RowIndexedValue;
import ca.uwindsor.cs.mkargar.od.metanome.sorting.partitions.SortedPartition;
import ca.uwindsor.cs.mkargar.od.metanome.sorting.partitions.SortedPartitionCreator;
import ca.uwindsor.cs.mkargar.od.metanome.types.ByteArrayPermutations;
import ca.uwindsor.cs.mkargar.od.metanome.types.Datatype;
import ca.uwindsor.cs.mkargar.od.metanome.types.TypeInferrer;
import ca.uwindsor.cs.mkargar.od.metanome.extra.CollectionUtils;
...
//        }
        ...
        //Mehdi
//        System.out.println("One OD is Found!");
//        System.out.println(orderDependency.toString());
